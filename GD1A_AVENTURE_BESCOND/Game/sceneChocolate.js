class sceneChocolate extends Phaser.Scene {
    ...
    create() {
        ...
        if (true) {
            ...
            this.toughts = this.add.text(200, 32, "The Chocolate Bastion", { fontSize: '32px', fill: '#FFF' }).setScrollFactor(0);
    ...
    obtainRessource(player, resource) {
        ...
        resource.destroy();
        this.scoreChoc.setText("H : " + this.resource_chocolate);
    }
