class sceneLollipop extends Phaser.Scene {
    ...
    create() {
        ...
        if (true) {
            ...
            //Création bait
            this.keyH = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.C);
            ...
            this.toughts = this.add.text(200, 32, "The Lollipop Ranch", { fontSize: '32px', fill: '#FFF' }).setScrollFactor(0);
        }
    }
    update() {
